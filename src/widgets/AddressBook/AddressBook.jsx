...
const AddressBook = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F5F7FA] font-['Montserrat'] py-6 lg:py-[40px]">
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* Заголовок менен Button ортосу 20px */}
        <div className="h-4 lg:h-[20px]" />

        {/* 3. Добавить новый адрес баскычы - Мобилдикте w-full */}
        <div className="px-4 lg:pl-[80px]">
          <button className="w-full lg:w-auto bg-[#122D52] text-white px-[30px] h-[48px] rounded-[8px] font-medium hover:bg-[#0d213d] transition-colors text-[14px] lg:text-[16px]">
            Добавить новый адрес
          </button>
        </div>

        {/* Button менен Карточканын ортосу 40px */}
        <div className="h-6 lg:h-[40px]" />

        {/* 4. Карточкалардын тизмеси */}
        <div className="px-4 lg:pl-[80px] flex flex-col gap-[20px] lg:gap-[25px]">
          {addresses.map((item) => (
            <div 
              key={item.id}
              className="w-full lg:w-[761px] min-h-[206px] lg:h-[206px] bg-white rounded-[12px] p-5 lg:p-[30px] flex flex-col justify-between relative"
              style={{
            ...
            >
              ...
              {/* Баскычтар: Мобилдикте астында жана бир катарда */}
