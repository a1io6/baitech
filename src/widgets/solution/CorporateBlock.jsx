...
import { Link } from 'react-router-dom'; // 'react-router' ордуна 'react-router-dom' колдонуу сунушталат
...
const CorporateBlock = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-[40px] bg-[#F5F7FA] py-10">
      {data.map((item) => (
        <div key={item.id} className="flex flex-col lg:flex-row w-full px-4 lg:px-0">
          ...
          {/* Сүрөт: Мобилдикте толук, ноутбукта 527x327px */}
